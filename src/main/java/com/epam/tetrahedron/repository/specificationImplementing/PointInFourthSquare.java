...
public class PointInFourthSquare implements Specification<Tetrahedron> {
    private final int requirement;
    private final Logger log = Logger.getLogger(PointInFourthSquare.class);
    public PointInFourthSquare(int requirement) {
